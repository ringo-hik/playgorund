...
exports.mockBuildResults = exports.mockBranches = exports.mockProjects = void 0;
exports.createMockBuildStatus = createMockBuildStatus;
// Mock 빌드 설정
...
// Mock 빌드 상태 생성 함수
function createMockBuildStatus(status, progress = 0) {
    ...
    return {
        ...
        logs: [
            ...
            ...(status === 'running' ? [{ timestamp: now, level: 'info', message: 'Build in progress...', source: 'BuildManager' }] : []),
            ...(status === 'success' ? [{ timestamp: now, level: 'info', message: 'Build completed successfully', source: 'BuildManager' }] : []),
            ...(status === 'failed' ? [{ timestamp: now, level: 'error', message: 'Build failed with errors', source: 'BuildManager' }] : [])
        ],
        rawLogs: [
            'Starting build...',
