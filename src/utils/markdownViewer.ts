...
import { getStatusIcon } from './iconUtils';

export class MarkdownViewer {
  private static panels: Map<string, vscode.WebviewPanel> = new Map();

  static async showBuildDetails(buildResult: BuildResult): Promise<void> {
  ...
  private static getBuildDetailsHtml(buildResult: BuildResult): string {
